...
### Síntesis sobre los mapas y la cartografía

> Un mapa es una representación gráfica o modelo a escala de conceptos espaciales por lo que so el medio para transmitir información geográfica. Los mapas son un medio universal de comunicación, fácilmente comprensible y apreciado por la mayoría de las personas, independientemente de su idioma o cultura. Un mapa implica la comprensión de que es una "instantánea" de una idea, una imagen única, una selección de conceptos de una base de datos de información geográfica en constante evolución (Merriam, 1996).

> Los mapas antiguos proporcionan mucha información sobre lo que se conocía en el pasado, así como sobre la filosofía y la base cultural del mapa, que a menudo diferían mucho de la cartografía moderna. Los mapas son uno de los medios por los cuales los científicos difunden sus ideas y las transmiten a las generaciones futuras (Merriam, 1996).

> La cartografía es el arte y la ciencia de elaborar mapas. Los mapas más antiguos conocidos se conservan en tablillas de arcilla babilónicas de aproximadamente el 2300 a. C. La cartografía alcanzó un desarrollo considerable en la antigua Grecia. El concepto de una Tierra esférica era bien conocido entre los filósofos griegos en la época de Aristóteles (ca. 350 a. C.) y ha sido aceptado por todos los geógrafos desde entonces. La cartografía griega y romana alcanzó su máximo esplendor con Claudio Ptolomeo (Ptolomeo, aproximadamente entre el 85 y el 165 d. C.). Su "mapamundi" representaba el Viejo Mundo desde aproximadamente las latitudes 60° N a 30° S. Escribió una obra monumental, Guía de Geografía (Geographike hyphygesis), que se mantuvo como una referencia autorizada en geografía mundial hasta el Renacimiento.

> Durante la época medieval, los mapas europeos estaban dominados por las concepciones religiosas. El mapa T-O era común. En este formato, Jerusalén se representaba en el centro y el este se orientaba hacia la parte superior. Las exploraciones vikingas en el Atlántico Norte se incorporaron gradualmente a la cosmovisión a partir del siglo XII. Mientras tanto, la cartografía se desarrolló de forma más práctica y realista en tierras árabes, incluida la región mediterránea. Todos los mapas se dibujaban e iluminaban a mano, lo que limitaba enormemente su distribución. 

> A partir del siglo XV y la llegada del Renacimiento, la invención de la imprenta facilitó la disponibilidad de mapas . Inicialmente, los mapas se imprimían con bloques de madera tallada. La impresión con placas de cobre grabadas apareció en el siglo XVI y continuó siendo el estándar hasta el desarrollo de las técnicas fotográficas. Los principales avances en cartografía se produjeron durante la Era de la Exploración, en los siglos XV y XVI. Los cartógrafos respondieron con cartas náuticas, que representaban líneas costeras, islas, ríos, puertos y accidentes geográficos de interés para la navegación. Se incluían líneas de brújula y otras ayudas para la navegación. Dichos mapas eran de gran valor para fines económicos, militares y diplomáticos, por lo que a menudo se consideraban secretos nacionales o comerciales: mapas clasificados o de propiedad exclusiva.

> Los primeros mapamundis comenzaron a aparecer a principios del siglo XVI, tras los viajes de Colón y otros al Nuevo Mundo. Gerardus Mercator de Flandes (Bélgica) fue el cartógrafo más destacado de mediados del siglo XVI. Desarrolló una proyección cilíndrica que aún se utiliza ampliamente para cartas de navegación y mapas globales. Publicó un mapamundi en 1569 basado en esta proyección. Pronto se desarrollaron muchas otras proyecciones cartográficas.

> Los mapas se volvieron cada vez más precisos y objetivos durante los siglos XVII, XVIII y XIX con la aplicación de métodos científicos. Muchos países implementaron programas cartográficos nacionales. Sin embargo, gran parte del mundo era poco conocido hasta el uso generalizado de la fotografía aérea tras la Segunda Guerra Mundial. La cartografía moderna se basa en una combinación de observaciones terrestres y teledetección.

> ¿Son los mapas representaciones realistas del mundo real? La resupesta es no. Las mediciones de campo están sujetas a errores de exactitud y precisión. Las fotografías aéreas y las imágenes satelitales representan solo ciertas porciones del espectro de luz, tal como se filtra a través de la atmósfera y los instrumentos de detección. Ningún mapa puede representar todas las características físicas, biológicas y culturales, ni siquiera en el área más pequeña. Un mapa solo puede mostrar unas pocas características seleccionadas, que suelen representarse con un estilo altamente simbólico según algún tipo de esquema de clasificación. De esta manera, todos los mapas son estimaciones, generalizaciones e interpretaciones de las condiciones geográficas reales. Todos los mapas se elaboran según ciertos supuestos básicos, por ejemplo, el datum del nivel del mar, que no siempre son verdaderos ni verificables. Finalmente, cualquier mapa es producto del esfuerzo humano y, como tal, puede estar sujeto a errores involuntarios, tergiversaciones, sesgos o fraudes flagrantes. A pesar de estas limitaciones, los mapas han demostrado ser notablemente adaptables y útiles a lo largo de varios milenios de civilización humana. Los mapas de todo tipo son de fundamental importancia para la sociedad moderna.